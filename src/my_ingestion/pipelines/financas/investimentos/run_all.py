...
FGC roda à parte (depende da camada intermediate do DW):
    ...
    python -m my_ingestion.pipelines.financas.investimentos.run_all          # todas
    python -m my_ingestion.pipelines.financas.investimentos.run_all b3       # uma só
    python -m my_ingestion.pipelines.financas.investimentos.run_all fgc
"""
...
from my_ingestion.pipelines.financas.investimentos.avenue_etl import (
    run_avenue_dividends_etl,
    run_avenue_etl,
)
from my_ingestion.pipelines.financas.investimentos.b3_etl import run_consolidation
from my_ingestion.pipelines.financas.investimentos.fgc_etl import build_depara
from my_ingestion.pipelines.financas.investimentos.google_finance_etl import (
