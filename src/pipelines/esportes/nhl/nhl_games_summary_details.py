"""NHL — Right-rail (estatísticas do jogo).
...
if __name__ == "__main__":
    run_dynamic("games_summary_details", logger, skip_extract="--load-only" in sys.argv)
    # uv run python -m pipelines.esportes.nhl.nhl_games_summary_details [--load-only]
