...
from pipelines.energia.solar.extraction import (
    Credentials,
    PathsConfig,
    SeleniumConfig,
    run_pipeline,
)
from pipelines.energia.solar.missing_raw import (
    identify_and_write_missing_dates,
)
from pipelines.energia.solar.transforming import (
...
if __name__ == "__main__":
    ...
    # python -m pipelines.energia.solar.run
